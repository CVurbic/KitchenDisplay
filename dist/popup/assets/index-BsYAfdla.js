(function() {let __HMR_ID = "0.r7fd3p1hvip";
(function () {
  'use strict';
...
function useStorageSuspense(storage2) {
...
function withSuspense(Component, SuspenseComponent) {
  return function WithSuspense(props) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: SuspenseComponent, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Component, __spreadValues$2({}, props)) });
  };
}
...
function withErrorBoundary(Component2, ErrorComponent) {
  return function WithErrorBoundary(props) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBoundary, { fallback: ErrorComponent, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Component2, __spreadValues$1({}, props)) });
  };
}
...
const Popup = () => {
  ...
  const [onOffCollor, setOnOffCollor] = reactExports.useState(true);
  const [higlightArticle, setHighlightArticle] = reactExports.useState();
  const [popisArtikala, setPopisArtikala] = reactExports.useState([]);
  const [settings, setSettings] = reactExports.useState({ highlightArticle: 0, onOffCollors: false });
  reactExports.useEffect(() => {
    injectContentScript();
    setInitialValues();
    chrome.storage.local.get("popisArtikala", function(data) {
      if (!data.popisArtikala) return;
      let noviPopisArtikala = data.popisArtikala.sort((a, b) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `App ${isLight ? "bg-slate-50" : "bg-gray-800"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: `App-header ${isLight ? "text-gray-900" : "text-gray-100"}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: chrome.runtime.getURL(logo), className: "App-logo", alt: "logo" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Ukljući / Iskljući boje:" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          ...
          id: "colorCheckbox",
          checked: onOffCollor,
          onChange: (e) => setOnOffCollor(e.target.checked)
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Naglasi artikl:" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { name: "highlightArtikl", id: "highlightArtikl", value: higlightArticle, onChange: (e) => setHighlightArticle(e.target.value), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "0", children: "Default" }),
        popisArtikala.map((artikl, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: artikl.id_artikla, children: artikl.naziv_artikla }, index))
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleSaveForm, children: "Spremi" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleButton, { children: "Toggle theme" })
  ] }) });
};
const ToggleButton = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      className: props.className + " font-bold mt-4 py-1 px-4 rounded shadow hover:scale-105 " + (theme === "light" ? "bg-white text-black shadow-black" : "bg-black text-white"),
...
init();
//# sourceMappingURL=index-BsYAfdla.js.map
