(function() {let __HMR_ID = "0.cx64p1h08zi";
(function () {
  'use strict';
...
const Panel = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `App ${isLight ? "bg-slate-50" : "bg-gray-800"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: `App-header ${isLight ? "text-gray-900" : "text-gray-100"}`, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
      "Edit ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: "pages/devtools-panel/src/Panel.tsx" })
    ] }),
...
const ToggleButton = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      className: props.className + " font-bold mt-4 py-1 px-4 rounded shadow hover:scale-105 " + (theme === "light" ? "bg-white text-black" : "bg-black text-white"),
      onClick: exampleThemeStorage.toggle,
      children: props.children
    }
  );
};
const Panel$1 = withErrorBoundary(withSuspense(Panel, /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: " Loading ... " })), /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: " Error Occur " }));
function init() {
  ...
  root.render(/* @__PURE__ */ jsxRuntimeExports.jsx(Panel$1, {}));
}
init();
//# sourceMappingURL=index-CQeNqxoO.js.map
